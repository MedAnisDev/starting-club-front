...
function HomePage() {
  ...
  return (
    <>
      <div
        className={`home-page ${
          scrolling ? "scroll-blur blur" : "scroll-blur"
        }`}
      >
        {/* Club Logo */}
        ...
        <section className="club-description">
          ...
          <p className="animated-description">
            Le Starting Club de Nabeul, fondé en 2017, est un club d'athlétisme
            dynamique. Nous avons pour mission de promouvoir l'excellence
            sportive et d'encourager une communauté passionnée de sport. Avec
            plus de 380 membres, nous formons des champions pour l'avenir tout
            en favorisant l'inclusion sociale à travers l'athlétisme.
          </p>
        </section>
